    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white p-8 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mt-8 text-center text-gray-400 text-sm">
          <p>Disclaimer: This website is completely unnecessary and exists purely for satirical purposes.</p>
          <p>No actual brain cells were harmed in the making of this interface.</p>
        </div>
      </div>
